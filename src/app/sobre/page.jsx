  ...
  return (
    <div>
      ...
      <div className="conteiner mx-auto px-4">
        <div className="relative w-64 h-64 mx-auto opacity-0 animate-fadeIn">
        ...
        <h1 className="text-2xl font-bold mt-4 font-raleway opacity-0 animate-fadeIn">Sobre mim</h1>
      <section className="mt-4 font-roboto transform translate-y-10 opacity-0 animate-slideUp">
